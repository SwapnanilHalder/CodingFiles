...
int main() {
    SPEED1;
    Solution mySolution;
    vector<vector<int>> arr{{1,2},{3,4},{4,5},{3,5}};
    vector<int> arr1{4,3,6,7}, 
    arr2{14,13,16,44,8,20,51,15,46,76,51,20,77,13,14,35,6,34,34,13,3,8,1,1,61,5,2,15,18};
    int start = 3;
    string str = "abcdefg";
    cout << "Answer : " << endl;
    cout << mySolution.minStoneSum(arr1, start) << endl;
}